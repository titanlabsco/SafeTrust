...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-1/4 border-r border-gray-300 pr-4">
      <h2 className="text-lg font-semibold text-gray-800 mb-4">{t("profile.sideTitle")}</h2>
      <ul className="space-y-2">
        <li className="flex items-center text-orange-500 font-medium">
          <FaUser className="mr-2" /> {t("profile.account")}
        </li>
      </ul>
      <h2 className="text-lg font-semibold text-gray-800 mt-8 mb-4">{t("profile.sideSecondTitle")}</h2>
      <ul className="space-y-2">
