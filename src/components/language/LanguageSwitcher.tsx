  ...
  return (
    <div className="relative inline-block text-left z-50  ">
      <button
        ...
        className=" flex items-center w-36 gap-2 px-4 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
      >
